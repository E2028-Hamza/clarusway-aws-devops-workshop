...
VPC oluşturmak için izlenmesi gereken sıranın özeti:

Create VPC
Creat Gateway
IGW Action Menu: Attach IGW to VPC
VPC Action Menu: Edit DNS Hostname
Set the VPC Route Table: 00000:/0> IGW
Name Default Route Table: default labpvc