...
def main_get():
    return render_template('index.html', developer_name='Hamza Seyyah', not_valid=False)

@app.route('/', methods=['POST'])
def main_post():
    milli = request.form['number']
    ...
    return render_template('result.html', milliseconds = number , result = convert(number), developer_name='Hamza Seyyah')
